...
-- 3. diy_log — add 'project' column if table already existed without it
ALTER TABLE diy_log ADD COLUMN IF NOT EXISTS project text;

-- 4. weekly_plans — add 'plan' column
